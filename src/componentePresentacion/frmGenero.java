...
//        jTxtIdDocumento.setEditable(!sw);
    ...
    private void initComponents() {
        ...
        jTxtIdGenero = new javax.swing.JTextField();
        ...
        jTxtIdGenero.setEditable(false);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jTxtIdGenero, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jTxtIdGenero, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
    ...
    private void jBtnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnNuevoActionPerformed
        ...
        controles(false);
        try {
            this.jTxtIdGenero.setText(GeneroCN.getInstancia().generaCodigo());
    ...
    private void jBtnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnModificarActionPerformed
        String idGenero;
        limpiarTextos();
        idGenero=JOptionPane.showInputDialog("IdGenero a Modificar : ");
        Genero x;
        try {
            x = GeneroCN.getInstancia().buscarGenero(idGenero);
            if(x!=null) {
                this.jTxtIdGenero.setText(x.getIdgenero());
            ...
            JOptionPane.showMessageDialog(null,"El IdGenero no existe");
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null,ex.getMessage());
        }
    ...
    private void jBtnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGrabarActionPerformed
        ...
        if(this.jTxtIdGenero.getText().compareTo("")!=0 && this.jTxtDescr.getText().compareTo("")!=0 ) {
            idgenero=this.jTxtIdGenero.getText();
            descr=this.jTxtDescr.getText();

            if(reg) {
                try {
                    GeneroCN.getInstancia().insertar(idgenero, descr);
                ...
                try {
                    GeneroCN.getInstancia().actualizar(idgenero, descr);
    ...
    private javax.swing.JTextField jTxtIdGenero;
