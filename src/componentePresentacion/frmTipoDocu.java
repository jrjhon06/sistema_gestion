 ...
 * @author Enrique
 */
public class frmTipoDocu extends javax.swing.JInternalFrame {
    boolean reg;
    int pmod;
    /**
     * Creates new form frmTipoDocu
     */
    public frmTipoDocu() {
        initComponents();
//        setLocation(300,150);
...
//        jTxtIdDocumento.setEditable(!sw);
    ...
    private void initComponents() {
        ...
        jTxtIdDocumento = new javax.swing.JTextField();
        ...
        setTitle("Maestro Tipo Documentos");
        setName(""); // NOI18N
        try {
            setSelected(true);
        ...
        jTxtIdDocumento.setEditable(false);

        jTxtDescr.setInheritsPopupMenu(true);
        jTxtDescr.setName(""); // NOI18N
        jTxtDescr.setNextFocusableComponent(jBtnGrabar);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jTxtIdDocumento, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jTxtIdDocumento, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
        ...
        jTxtDescr.getAccessibleContext().setAccessibleDescription("");
    ...
    private void jBtnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnNuevoActionPerformed
        ...
        controles(false);
        try {
            this.jTxtIdDocumento.setText(TipoDocumentoCN.getInstancia().generaCodigo());
    ...
    private void jBtnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGrabarActionPerformed
        String iddocumento,descr;
        if(this.jTxtIdDocumento.getText().compareTo("")!=0 && this.jTxtDescr.getText().compareTo("")!=0 ) {
            iddocumento=this.jTxtIdDocumento.getText();
            descr=this.jTxtDescr.getText();
            
            if(reg) {
                try {
                    TipoDocumentoCN.getInstancia().insertar(iddocumento, descr);
                ...
                try {
                    TipoDocumentoCN.getInstancia().actualizar(iddocumento, descr);
    ...
    private void jBtnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnModificarActionPerformed
        String idCliente;
        limpiarTextos();
        idCliente=JOptionPane.showInputDialog("Id Tipo Documento a Modificar : ");
        TipoDocumento x;
        try {
            x = TipoDocumentoCN.getInstancia().buscarTipoDocumento(idCliente);
            if(x!=null) {
                this.jTxtIdDocumento.setText(x.getIddocumento());
                this.jTxtDescr.setText(x.getDescripcion());
                reg=false;
                textos(true);
//                txtIdCliente.setEditable(false);
                controles(false);
            } else
                JOptionPane.showMessageDialog(null,"El Id Tipo Documento no existe");
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null,ex.getMessage());
        }
    ...
    private javax.swing.JTextField jTxtIdDocumento;
